...
namespace ShopApp.ViewModels
{
    ...
    public partial class HelpSupportDetailViewModel : ViewModelGlobal, IQueryAttributable
    {
        ...
        public HelpSupportDetailViewModel(IConnectivity connectivity, CompraService compraService, ShopOutDbContext outDbContext)
        {
            ...
            {
                Debug.WriteLine("Excepción en HelpSupportDetailViewModel.cs >> HelpSupportDetailViewModel: " + ex.Message);
            }
        }
        ...
        private async Task EnviarCompra()
        {
            ...
            {
                Debug.WriteLine("Excepción en HelpSupportDetailViewModel.cs >> EnviarCompra: " + ex.Message);
            }
        }
